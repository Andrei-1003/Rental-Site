...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale']], function () {
    ...
    Route::get('all-messages', 'MessageController@_allMessages')->name('all-messages');

    Route::get('user-messages', 'MessageController@_userMessages')->name('user-messages');

    Route::post('delete-messages', 'NotificationController@_deleteMesages')->name('delete-messages');
});
