...
<?php
enqueue_style('dashboard-profile-css');
...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('My Profile')])
            {{--Start Content--}}
            <?php
                        ...
                        <form action="{{ dashboard_url('update-your-avatar') }}" class="form form-action"
                            ...
                            <div class="text-left mt-3">
                                ...
                                <p class="text-muted mb-2 font-13">
                                    ...
                                    <span class="ml-2">{{ $current_user->mobile }}</span>
                                </p>
                                <p class="text-muted mb-2 font-13">
                                    <strong>{{__('Foto ID:')}}</strong>
                                    <span class="ml-2">{{ $current_user->mobile }}</span>
                                </p>
                        ...
                        <form action="{{ dashboard_url('update-your-profile') }}" class="form form-action mt-3"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="input-group input-group-lg">
                                            <div class="btn btn-primary btn-file w-100" tabindex="500">
                                                <i class="glyphicon glyphicon-folder-open"></i>
                                                &nbsp;  
                                                <span class="hidden-xs">Upload Foto</span>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label for="mobile">{{__('State')}}</label>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label for="mobile">{{__('City/Regency')}}</label>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <label for="mobile">{{__('Zip code')}}</label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="description">{{__('My Bio')}}</label>
...
<?php
    enqueue_script('dashboard-profile-js');
?>
