...
class EnqueueScripts
{
    ...
    public function _registerScripts()
    {
        ...
        $this->addStyle('dashboard-profile-css', asset('css/dashboard/profile.css'));
        $this->addScript('dashboard-profile-js', asset('js/dashboard/profile.js'));
        
        $this->addStyle('dashboard-message-css', asset('css/dashboard/message.css'));
        $this->addScript('dashboard-message-js', asset('js/dashboard/message.js'));
