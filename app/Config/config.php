...
return [
    ...
    'admin_menu' => [
        ...
        [
            'type' => 'heading',
            'label' => awe_lang('Rent Services'),
            'id' => 'heading-services'
        ],
        [
            'type' => 'parent',
            'label' => awe_lang('Apartment Rental'),
            'service' => 'home',
            'icon' => '006_home',
            'child' => [
                [
                    'type' => 'item',
                    'label' => awe_lang('Add Unit'),
                    'screen' => 'add-new-home',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('Apartments Unit'),
                    'screen' => 'my-home',
                ],
                [
                    'type' => 'hidden',
